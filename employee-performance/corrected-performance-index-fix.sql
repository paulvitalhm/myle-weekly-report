...
-- This implements the documented formula correctly for November 15, 2025
-- The issue was that previous queries were summing across multiple days
...
BEGIN
    ...
    WITH work_day_totals AS (
        ...
        -- This is per day, not across all days
        SELECT 
            wd.work_date,
    ...
    revenue_allocation AS (
        ...
        -- This implements the documented formula correctly
        SELECT 
...
-- Test the corrected function for November 15, 2025
...
-- This should show the correct calculation: 38.49 for both
WITH day_totals AS (
    SELECT 
